      ...
      <section className="container max-w-max mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-20 py-20 lg:py-36 px-4">
        ...
        <div className="max-w-lg">
          ...
          <p className="text-black50 text-base/8">
            ...
            Fofood has been empowering communities since its inception. Our journey began with a
            deep understanding of the challenges faced by individuals living in areas devoid of
            accessible, nutritious food options. Driven by the desire to make a meaningful impact,
            we set out to create sustainable solutions that ensure everyone has the opportunity to
            enjoy fresh, healthy, and affordable meals.
          </p>
        </div>
      </section>
      <section className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 pb-20 lg:pb-36 px-4">
        <div className="">
          <div className="w-[58px] h-[58px] flex items-center justify-center text-pink100 font-fredoka font-bold text-2xl mb-6 rounded-full bg-pink10">
            01
          </div>
          <h3 className="font-bold mb-4">Collective Collaboration</h3>
          <p className="text-black50 text-base/8">
            We believe that real change happens when we join forces. By partnering with local
            residents, organizations, farmers, and businesses, we create a network of support,
            working together to establish sustainable solutions that break down barriers to food
            access.
          </p>
        </div>
        ...
        <div className="mt-8 md:mt-12">
          ...
          <p className="text-black50 text-base/8">
            At Fofood, our mission is simple – ensuring equitable access to fresh, healthy, and
            affordable food for all. We are dedicated to empowering communities affected by food
            deserts and improving overall well-being.
          </p>
        </div>
        ...
        <div className=" mt-8 md:mt-20">
          ...
          <p className="text-black50 text-base/8">
            Embracing the power of technology, we leverage our online platform to reach and empower
            a wider audience. Through our website, we provide valuable resources, including recipes,
            tips, and educational content, making healthy eating accessible to all and fostering
            positive change.
          </p>
        </div>
      </section>
      <section className="pb-20 lg:pb-36">
        <div className="container mx-auto flex flex-col lg:flex-row-reverse items-center gap-6 lg:gap-16 px-4">
          <div className="basis-1/2">
            <Image
              src="/images/video-image-min.png"
              height={201}
              width={343}
              alt="ddd"
          ...
          <div className="basis-1/2">
            ...
            <p className="text-black50 text-base/8">
              Through collaborative efforts with local residents, organizations, and key
              stakeholders, we have established a strong network of support. Over the years, we have
              implemented various initiatives such as community gardens, mobile markets, and
              educational programs focused on nutrition and culinary skills. By fostering community
              engagement and leveraging technology, we have amplified our impact and connected
              individuals to vital resources. Our history is rooted in the success stories of
              individuals and families who have gained improved access to nutritious food, leading
              to enhanced well-being and a stronger sense of community.
            </p>
          </div>
        </div>
      </section>
