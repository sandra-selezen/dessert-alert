...
import { popularPost } from '@/lib/data';
import { LatestPostSection } from '@/components/LatestPostSection/LatestPostSection';
      ...
      <section className="bg-pink10 pt-14">
        <div className="container mx-auto text-center py-16 lg:py-20">
          <p className="font-fredoka font-semibold text-black50">
            <Link href="/">Home</Link> <span className="text-pink100">/ Blog</span>
          </p>
