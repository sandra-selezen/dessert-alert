      ...
      <section className="bg-pink10 pt-14">
        <div className="container mx-auto text-center py-16 lg:py-20">
          <p className="font-fredoka font-semibold text-black50">
            <Link href="/">Home</Link> <span className="text-pink100">/ Menu</span>
          </p>
        ...
        <div className="flex flex-col md:flex-row gap-16 md:gap-20">
          ...
          <div className="basis-3/4">
            <div className="flex justify-between mb-8">
              ...
              <p className="font-fredoka font-semibold text-xl text-pink100">
              ...
              <ul className="grid grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-20">
                {filteredProducts.map((item) => (
                  <li key={item.id} className="flex flex-col items-center">
                    ...
                    <Link
                      href={`/menu/${item.id}`}
                      className="mb-2 font-bold hover:text-pink100 hover:underline transition-all"
                    >
                      {item.name}
                    </Link>
